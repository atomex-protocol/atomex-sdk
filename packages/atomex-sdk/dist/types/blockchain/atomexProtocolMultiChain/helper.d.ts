...
export declare const getRedeemRewardInNativeCurrency: (currencyOrId: Currency | Currency['id'], redeemFee: FeesInfo, priceManager: PriceManager, blockchainProvider: AtomexBlockchainProvider) => Promise<FeesInfo>;
