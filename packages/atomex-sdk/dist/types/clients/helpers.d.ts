...
export declare const mapOrderBookEntryDtoToOrderBookEntry: (entryDto: OrderBookEntryDto) => OrderBookEntry;
export declare const mapWebSocketOrderBookEntryDtoToOrderBooks: (orderBookEntryDtos: WebSocketOrderBookEntryDto[], orderBookProvider: OrderBookProvider) => OrderBook[];
