...
declare type CheckErrorType<TErrorId extends string, TError extends SwapPreviewErrorBase<TErrorId>> = TError;
declare type NotEnoughFundsSwapPreviewError = CheckErrorType<'not-enough-funds', {
...
export declare type SwapPreviewError = CheckErrorType<string, NotEnoughFundsSwapPreviewError | {
