...
export declare abstract class Helpers {
     ...
     */
    abstract getAuthMessage(message: string, address?: string): AuthMessage;
    /**
     ...
     */
    abstract buildInitiateTransaction(initiateParameters: InitiateParameters): PartialTransactionBody;
    /**
     ...
     * @returns contract address and tx data that can be used to make a contract call
     */
    abstract buildRedeemTransaction(secret: string, hashedSecret: string): PartialTransactionBody;
    /**
