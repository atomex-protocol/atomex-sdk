...
var TezosUtil = /** @class */ (function () {
    ...
    TezosUtil.prototype.connect = function (rpc) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var tezos, chainID, conf;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        chainID = _b.sent();
                        conf = config_json_1.default.tezos;
                        ...
                        this._init = true;
                        this._contractAddr = (_a = Object.getOwnPropertyDescriptor(conf.chains, chainID.toString())) === null || _a === void 0 ? void 0 : _a.value.contract;
    ...
    TezosUtil.prototype.status = function () {
        if (!this._init)
            throw new Error("TezosUtil was not setup properly");
    };
    TezosUtil.prototype.initiate = function (_a) {
        var hashedSecret = _a.hashedSecret, participant = _a.participant, refundTimestamp = _a.refundTimestamp, payoff = _a.payoff;
        this.status();
        ...
        var parameter = this._contract.Encode("initiate", participant, hashedSecret, refundTimestamp, payoff);
        return {
            parameter: parameter,
    ...
    TezosUtil.prototype.getCurrentHeadDetails = function (blockLevel) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TezosUtil.prototype.validateSwapTransaction = function (blockHeight, txID, expectedData, confirmations) {
        if (confirmations === void 0) { confirmations = 5; }
        return __awaiter(this, void 0, void 0, function () {
            var swapData, amount, headDetails, txBlockDetails;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (swapData["participant"] !== expectedData._participant ||
                            ...
                            return [2 /*return*/, false];
                        return [4 /*yield*/, this.getCurrentHeadDetails("head")];
                    case 2:
                        headDetails = _a.sent();
                        return [4 /*yield*/, this.getCurrentHeadDetails(blockHeight)];
                    case 3:
                        txBlockDetails = _a.sent();
                        if (headDetails.level - txBlockDetails.level < confirmations &&
