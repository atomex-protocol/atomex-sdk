...
var TezosUtil = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (chainDetails.chainID !== chainID.toString()) {
                            throw new Error("Wrong RPC: Chain with Chain-ID " + chainID + " Not Supported");
                        }
                        this._rpc = chainDetails.rpc;
                        this._chainClient = tezos;
                        this._init = true;
                        this._contractAddr = chainDetails.contract;
                        this._entrypoints = new Map(Object.entries(config_json_1.default.tezos.entrypoints).map(function (_a) {
                            var name = _a[0], typeExpr = _a[1];
                            return [name, new michelson_encoder_1.ParameterSchema(typeExpr)];
                        }));
    ...
    TezosUtil.prototype.initiate = function (swapDetails) {
        ...
        var parameter = (_a = this._entrypoints
            .get("initiate")) === null || _a === void 0 ? void 0 : _a.Encode(swapDetails.participant, swapDetails.hashedSecret, swapDetails.refundTimestamp, swapDetails.payoff);
        return {
            parameter: parameter,
    ...
    TezosUtil.prototype.redeem = function (secret) {
        var _a;
        this.status();
        var parameter = (_a = this._entrypoints.get("redeem")) === null || _a === void 0 ? void 0 : _a.Encode(secret);
        return {
            parameter: parameter,
            contractAddr: this._contractAddr,
        };
    ...
    TezosUtil.prototype.refund = function (hashedSecret) {
        ...
        this.status();
        var parameter = (_a = this._entrypoints
            .get("refund")) === null || _a === void 0 ? void 0 : _a.Encode(hashedSecret);
        return {
            parameter: parameter,
            contractAddr: this._contractAddr,
        };
    ...
    TezosUtil.prototype.add = function (hashedSecret) {
        ...
        this.status();
        var parameter = (_a = this._entrypoints
            .get("add")) === null || _a === void 0 ? void 0 : _a.Encode(hashedSecret);
        return {
            parameter: parameter,
            contractAddr: this._contractAddr,
        };
                                    ...
                                    if (op.hash === txID) {
                                        op.contents.forEach(function (content) {
                                            ...
                                            if (content.destination !== _this._contractAddr ||
                                                ...
                                                return;
                                            var params = (_a = _this._entrypoints
                                                .get(content.parameters.entrypoint)) === null || _a === void 0 ? void 0 : _a.Execute(content.parameters.value);
