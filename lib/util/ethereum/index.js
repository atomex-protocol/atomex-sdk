...
var EthereumUtil = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.status();
                        return [4 /*yield*/, this.getTxData(txHash)];
                    case 1:
                        txData = _b.sent();
                        if (txData === undefined ||
    ...
    EthereumUtil.prototype.slice = function (i, j, bs) {
        return "0x" + bs.slice(i * 2 + 2, j * 2 + 2);
    };
    EthereumUtil.prototype.length = function (sig) {
     ...
     */
    EthereumUtil.prototype.recoverPubKey = function (msg, signature) {
        this.status();
        var hash = this._chainClient.eth.accounts.hashMessage(msg);
        var vals = [
