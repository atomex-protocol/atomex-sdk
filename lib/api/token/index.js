 ...
 */
exports.getAuthToken = function (authParam) { return __awaiter(void 0, void 0, void 0, function () {
    var url, body;
    return __generator(this, function (_a) {
        url = new URL(util_1.getBasePath() + "/Token");
        body = __assign(__assign({}, authParam), { algorithm: authParam.algorithm + ":" + authParam.curve });
        delete body.curve;
