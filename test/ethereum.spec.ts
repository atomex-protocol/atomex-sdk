...
describe("EthereumHelpers test", () => {
  ...
  test("parseInitiateParameters", () => {
    ...
    expect(params.secretHash).toBe("e0f9d71ecb40fa22b0146e8e8b1668a0cce1d3651c421ec1f8a344353320cb77");
    expect(params.refundTimestamp).toBe(1604545434);
    expect(params.rewardForRedeem).toBe(10000000000000000);
    expect(params.receivingAddress.toLowerCase()).toBe("0x9ffDD2871e06Df76E7245b8Be91E2af409F37Eda".toLowerCase());
